...
public:
	...
	using Factory = std::function<std::unique_ptr<ynet::Client>(ynet::Client::Callbacks&)>;
...
public:
	...
	using Factory = std::function<std::unique_ptr<ynet::Server>(ynet::Server::Callbacks&)>;
